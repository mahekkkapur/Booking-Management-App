                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => Recipe(
                              ...
                              image: widget.image,
                              docId: widget.docId,
                              firebaseImage: widget.firebaseImage)));
                },
                child: Container(
                  width: 60.0,
                  height: 60.0,
                ...
                child: GestureDetector(
                  onTap: () async {
                    ...
                    if (response.statusCode == 200) {
                      ...
                      temp["nutrition"]["nutrients"].add({
                        "title": nutrients["totalNutrients"]["ENERC_KCAL"]
                            ["label"],
                        "quantity": nutrients["totalNutrients"]["ENERC_KCAL"]
                            ["quantity"],
                    ...
                    if (widget.image != null) {
                      ...
                      await storageReference.putFile(widget.image).onComplete;
                      imageUrl = await storageReference.getDownloadURL();
                    } else {
                      imageUrl = widget.firebaseImage;
                    }
